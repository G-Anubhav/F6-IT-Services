...
import icon1 from '../../../images/icon/user-icon-blue.png'
import icon2 from '../../../images/icon/music-play-blue.png'
import icon3 from '../../../images/icon/dollar-circle-blue-new.png'
...
const FeatureSection = (props) => {
    ...
    return (
        <div className="feature  pt-10 pb-130">
