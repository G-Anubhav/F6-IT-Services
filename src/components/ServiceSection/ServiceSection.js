...
const ServiceSection = (props) => {
    ...
    return (
        <section className="service pt-140 pb-70">
                        ...
                        <div className="service-info">
                            <div className="sec-title--two">
                                ...
                                <Fade direction='up' triggerOnce={'false'} duration={1200} delay={9}>
                                    <div>
                                        <h2 className="title"> Growth with <br /> Best Digital Marketing <br /> Services</h2>
                                    </div>
                                </Fade>
                                <Fade direction='up' triggerOnce={'false'} duration={1400} delay={9}>
                                    <div>
                                        <p className="content">We deliver focused, results-driven strategies to help your business thrive in the digital era.</p>
                                    </div>
                                </Fade>
                            </div>
